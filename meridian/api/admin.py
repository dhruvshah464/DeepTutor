...
from meridian.persistence.models.org import Organization
from meridian.persistence.models.session import ChatSession
from meridian.persistence.models.user import User
from meridian.platform.auth.dependencies import require_role
...
async def admin_health(
    ...
    # LLM
    try:
        from meridian.bridge.engine import get_llm_client
        llm = get_llm_client()
    ...
    # Embedding
    try:
        from meridian.bridge.engine import get_embedding_client
