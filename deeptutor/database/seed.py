...
Run with: python -m deeptutor.database.seed
"""
...
from deeptutor.database.engine import get_async_session, init_db
from deeptutor.database.models.billing import Plan, PlanTier
